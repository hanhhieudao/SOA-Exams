...
% They get clobbered by hide.  
  ...
  \define@key{hide}{comments}[true]{\renewenvironment{comments}{\comment}{\endcomment}}  \define@key{hide}{definition}[true]{\renewenvironment{definition}{\comment}{\endcomment}}
...
\ShowEnvirons{definition,terminology, proof, example, comments}
%------------------------